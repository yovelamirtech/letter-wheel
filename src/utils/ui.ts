...
// מרחק אנכי מראש האזור הבטוח (safe area) - המסך שמשתמש בזה עטוף ב-SafeAreaView,
// כך שהמרחק הזה הוא "בונוס" מעל האינסט של המכשיר (notch/Dynamic Island),
// ולא מרחק גולמי מקצה הפיזי של המסך.
